...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CityModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.code, code) || other.code == code)&&(identical(other.deviceCount, deviceCount) || other.deviceCount == deviceCount));
}
...
@override
String toString() {
  return 'CityModel(id: $id, name: $name, code: $code, deviceCount: $deviceCount)';
}
...
@useResult
$Res call({
 String id, String name, String code,@JsonKey(name: 'device_count') int deviceCount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String code, @JsonKey(name: 'device_count')  int deviceCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CityModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String code, @JsonKey(name: 'device_count')  int deviceCount)  $default,) {final _that = this;
switch (_that) {
case _CityModel():
return $default(_that.id,_that.name,_that.code,_that.deviceCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String code, @JsonKey(name: 'device_count')  int deviceCount)?  $default,) {final _that = this;
switch (_that) {
case _CityModel() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.deviceCount);case _:
  return null;
...
class _CityModel extends CityModel {
  const _CityModel({required this.id, required this.name, required this.code, @JsonKey(name: 'device_count') required this.deviceCount}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CityModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.code, code) || other.code == code)&&(identical(other.deviceCount, deviceCount) || other.deviceCount == deviceCount));
}
