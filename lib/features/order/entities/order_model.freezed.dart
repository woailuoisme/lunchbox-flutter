...
bool operator ==(Object other) {
  return identical(this, other) ||
      (other.runtimeType == runtimeType && other is OrderModel &&
          ...
          (identical(other.pickupHint, pickupHint) ||
              other.pickupHint == pickupHint) &&
          (identical(other.diningCode, diningCode) ||
              other.diningCode == diningCode) &&
...
as DateTime?,pickupCode: freezed == pickupCode ? _self.pickupCode : pickupCode // ignore: cast_nullable_to_non_nullable
  as String?,
    pickupHint: freezed == pickupHint
        ? _self.pickupHint
        : pickupHint // ignore: cast_nullable_to_non_nullable
    as String?,
    diningCode: freezed == diningCode
        ? _self.diningCode
        : diningCode // ignore: cast_nullable_to_non_nullable
    as String?,
...
class _OrderModel extends OrderModel {
  const _OrderModel(
      {required this.id, required this.userId, required this.deviceId, required final List<
          CartItemModel> items, required this.totalAmount, required this.createdAt, this.device, this.paidAmount = 0.0, this.status = OrderStatus
          .pending, this.paymentMethod, this.paidAt, this.completedAt, this.cancelledAt, this.pickupCode, this.pickupHint, this.diningCode, this.storeName, this.storeAddress, this.storePhone, this.qrCodeData, this.remark})
      : _items = items,
        super._();
...
bool operator ==(Object other) {
  return identical(this, other) ||
      (other.runtimeType == runtimeType && other is _OrderModel &&
          (identical(other.id, id) || other.id == id) &&
          (identical(other.userId, userId) || other.userId == userId) &&
          (identical(other.deviceId, deviceId) || other.deviceId == deviceId) &&
