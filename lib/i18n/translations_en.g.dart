...
class _TranslationsHomeEn extends TranslationsHomeZhCn {
  ...
  @override
  String get banner1Title => TranslationOverrides.string(_root.$meta, 'home.banner1Title', {}) ?? 'Convenient';
  @override
  String get banner1Subtitle =>
      TranslationOverrides.string(_root.$meta, 'home.banner1Subtitle', {}) ?? 'Delicious on the go';
  @override
  String get banner2Title => TranslationOverrides.string(_root.$meta, 'home.banner2Title', {}) ?? 'Fresh Delivery';
  @override
  String get banner2Subtitle => TranslationOverrides.string(_root.$meta, 'home.banner2Subtitle', {}) ?? 'Daily Updates';
  @override
  String get banner3Title => TranslationOverrides.string(_root.$meta, 'home.banner3Title', {}) ?? 'Best Offers';
  @override
  String get banner3Subtitle =>
      TranslationOverrides.string(_root.$meta, 'home.banner3Subtitle', {}) ?? 'Limited Time Only';
  @override
  String get noDevices => TranslationOverrides.string(_root.$meta, 'home.noDevices', {}) ?? 'No devices nearby';
  @override
  String get welcome => TranslationOverrides.string(_root.$meta, 'home.welcome', {}) ?? 'Hello, User';
  @override
  String get selfPickup => TranslationOverrides.string(_root.$meta, 'home.selfPickup', {}) ?? 'Self Pickup';
  @override
  String get selfPickupHint =>
      TranslationOverrides.string(_root.$meta, 'home.selfPickupHint', {}) ?? 'Scan code to pick up/Take away';
  @override
  String get teamOrder => TranslationOverrides.string(_root.$meta, 'home.teamOrder', {}) ?? 'Team Order';
  @override
  String get teamOrderHint =>
      TranslationOverrides.string(_root.$meta, 'home.teamOrderHint', {}) ?? 'Group ordering/Team meal';
  @override
  String get invite => TranslationOverrides.string(_root.$meta, 'home.invite', {}) ?? 'Invite & Earn';
  @override
  String get inviteHint =>
      TranslationOverrides.string(_root.$meta, 'home.inviteHint', {}) ?? 'Invite friends to get cash';
  @override
...
class _TranslationsPointsEn extends TranslationsPointsZhCn {
  ...
  // Translations
  @override
  String get title => TranslationOverrides.string(_root.$meta, 'points.title', {}) ?? 'My Coins';
  @override
  String get unit => TranslationOverrides.string(_root.$meta, 'points.unit', {}) ?? 'Coins';
  @override
  String get mall => TranslationOverrides.string(_root.$meta, 'points.mall', {}) ?? 'Coin Mall';
  @override
  String get goExchange => TranslationOverrides.string(_root.$meta, 'points.goExchange', {}) ?? 'Go Exchange';
  @override
  String get rules => TranslationOverrides.string(_root.$meta, 'points.rules', {}) ?? 'Coin Rules';
  @override
  String get rule1 => TranslationOverrides.string(_root.$meta, 'points.rule1', {}) ?? 'Coins are permanently valid';
  @override
  String get rule2 =>
      TranslationOverrides.string(_root.$meta, 'points.rule2', {}) ?? 'Extra coins can be obtained by lottery';
  @override
  String get records => TranslationOverrides.string(_root.$meta, 'points.records', {}) ?? 'Coin Records';
  @override
  ...
  @override
  String get noRecords => TranslationOverrides.string(_root.$meta, 'points.noRecords', {}) ?? 'No coin records';
  @override
  ...
  String myPoints({required Object points}) =>
      TranslationOverrides.string(_root.$meta, 'points.myPoints', {'points': points}) ?? 'My Coins: ${points}';
  @override
  ...
  String cost({required Object points}) =>
      TranslationOverrides.string(_root.$meta, 'points.cost', {'points': points}) ?? '${points} Coins';
  @override
...
class _TranslationsHomeLotteryEn extends TranslationsHomeLotteryZhCn {
  ...
  @override
  String get rules => TranslationOverrides.string(_root.$meta, 'home.lottery.rules', {}) ?? 'Draw Rules';
  @override
  String get remaining =>
      TranslationOverrides.string(_root.$meta, 'home.lottery.remaining', {}) ?? 'Remaining: {count}';
  @override
  ...
  @override
  String get prizeUnit => TranslationOverrides.string(_root.$meta, 'home.lottery.prizeUnit', {}) ?? 'Coins';
  @override
...
class _TranslationsHomeLotteryPrizeCardEn extends TranslationsHomeLotteryPrizeCardZhCn {
  ...
  @override
  String get getTime =>
      TranslationOverrides.string(_root.$meta, 'home.lottery.prizeCard.getTime', {}) ?? 'Got at: {time}';
  @override
  String get expiryTime =>
      TranslationOverrides.string(_root.$meta, 'home.lottery.prizeCard.expiryTime', {}) ?? 'Expiry: {time}';
  @override
...
extension on TranslationsEn {
  dynamic _flatMapFunction(String path) {
    return switch (path) {
          ...
          'home.banner1Title' => TranslationOverrides.string(_root.$meta, 'home.banner1Title', {}) ?? 'Convenient',
          'home.banner1Subtitle' =>
            TranslationOverrides.string(_root.$meta, 'home.banner1Subtitle', {}) ?? 'Delicious on the go',
          'home.banner2Title' => TranslationOverrides.string(_root.$meta, 'home.banner2Title', {}) ?? 'Fresh Delivery',
          'home.banner2Subtitle' =>
            TranslationOverrides.string(_root.$meta, 'home.banner2Subtitle', {}) ?? 'Daily Updates',
          'home.banner3Title' => TranslationOverrides.string(_root.$meta, 'home.banner3Title', {}) ?? 'Best Offers',
          'home.banner3Subtitle' =>
            TranslationOverrides.string(_root.$meta, 'home.banner3Subtitle', {}) ?? 'Limited Time Only',
          'home.noDevices' => TranslationOverrides.string(_root.$meta, 'home.noDevices', {}) ?? 'No devices nearby',
          'home.welcome' => TranslationOverrides.string(_root.$meta, 'home.welcome', {}) ?? 'Hello, User',
          ...
          'home.teamOrderHint' =>
            TranslationOverrides.string(_root.$meta, 'home.teamOrderHint', {}) ?? 'Group ordering/Team meal',
          'home.invite' => TranslationOverrides.string(_root.$meta, 'home.invite', {}) ?? 'Invite & Earn',
          'home.inviteHint' =>
            TranslationOverrides.string(_root.$meta, 'home.inviteHint', {}) ?? 'Invite friends to get cash',
          'home.recommendTitle' =>
            TranslationOverrides.string(_root.$meta, 'home.recommendTitle', {}) ?? 'Recommended for Me',
          ...
          'home.lottery.rules' => TranslationOverrides.string(_root.$meta, 'home.lottery.rules', {}) ?? 'Draw Rules',
          ...
          'home.lottery.rule3' =>
            TranslationOverrides.string(_root.$meta, 'home.lottery.rule3', {}) ?? 'Platform reserves all rights',
          'home.lottery.prizeUnit' => TranslationOverrides.string(_root.$meta, 'home.lottery.prizeUnit', {}) ?? 'Coins',
          ...
          'points.title' => TranslationOverrides.string(_root.$meta, 'points.title', {}) ?? 'My Coins',
          'points.unit' => TranslationOverrides.string(_root.$meta, 'points.unit', {}) ?? 'Coins',
          'points.mall' => TranslationOverrides.string(_root.$meta, 'points.mall', {}) ?? 'Coin Mall',
          'points.goExchange' => TranslationOverrides.string(_root.$meta, 'points.goExchange', {}) ?? 'Go Exchange',
          'points.rules' => TranslationOverrides.string(_root.$meta, 'points.rules', {}) ?? 'Coin Rules',
          'points.rule1' =>
            TranslationOverrides.string(_root.$meta, 'points.rule1', {}) ?? 'Coins are permanently valid',
          'points.rule2' =>
            TranslationOverrides.string(_root.$meta, 'points.rule2', {}) ?? 'Extra coins can be obtained by lottery',
          'points.records' => TranslationOverrides.string(_root.$meta, 'points.records', {}) ?? 'Coin Records',
          ...
          'points.noRecords' => TranslationOverrides.string(_root.$meta, 'points.noRecords', {}) ?? 'No coin records',
