...
class TranslationsPointsZhCn {
  ...
  /// zh-CN: '我的乖乖币'
  String get title =>
      TranslationOverrides.string(_root.$meta, 'points.title', {}) ?? '我的乖乖币';

  /// zh-CN: '乖乖币'
  String get unit =>
      TranslationOverrides.string(_root.$meta, 'points.unit', {}) ?? '乖乖币';

  /// zh-CN: '乖乖币商城'
  String get mall =>
      TranslationOverrides.string(_root.$meta, 'points.mall', {}) ?? '乖乖币商城';
  ...
  /// zh-CN: '乖乖币规则'
  String get rules =>
      TranslationOverrides.string(_root.$meta, 'points.rules', {}) ?? '乖乖币规则';

  /// zh-CN: '乖乖币永久有效'
  String get rule1 =>
      TranslationOverrides.string(_root.$meta, 'points.rule1', {}) ?? '乖乖币永久有效';
  ...
  /// zh-CN: '乖乖币记录'
  String get records =>
      TranslationOverrides.string(_root.$meta, 'points.records', {}) ?? '乖乖币记录';
...
class TranslationsProfileZhCn {
  ...
  /// zh-CN: '乖乖币'
  String get coin =>
      TranslationOverrides.string(_root.$meta, 'profile.coin', {}) ?? '乖乖币';
    ...
    return switch (path) {
          ...
          'points.title' =>
            TranslationOverrides.string(_root.$meta, 'points.title', {}) ??
                '我的乖乖币',
          'points.unit' =>
            TranslationOverrides.string(_root.$meta, 'points.unit', {}) ??
                '乖乖币',
          'points.mall' =>
