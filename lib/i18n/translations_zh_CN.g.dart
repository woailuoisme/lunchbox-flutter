...
class Translations with BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsWelcomeGiftZhCn welcome_gift = TranslationsWelcomeGiftZhCn.internal(_root);
}
...
class TranslationsAuthZhCn {
  ...
  /// zh-CN: '重新发送'
  String get resendCode => TranslationOverrides.string(_root.$meta, 'auth.resendCode', {}) ?? '重新发送';

  /// zh-CN: '邮箱'
  String get email => TranslationOverrides.string(_root.$meta, 'auth.email', {}) ?? '邮箱';

  /// zh-CN: '请输入邮箱'
  String get enterEmail => TranslationOverrides.string(_root.$meta, 'auth.enterEmail', {}) ?? '请输入邮箱';

  /// zh-CN: '邮箱格式不正确'
  String get emailInvalid => TranslationOverrides.string(_root.$meta, 'auth.emailInvalid', {}) ?? '邮箱格式不正确';

  /// zh-CN: '旧密码'
  String get oldPassword => TranslationOverrides.string(_root.$meta, 'auth.oldPassword', {}) ?? '旧密码';

  /// zh-CN: '请输入旧密码'
  String get enterOldPassword => TranslationOverrides.string(_root.$meta, 'auth.enterOldPassword', {}) ?? '请输入旧密码';

  /// zh-CN: '新密码'
  String get newPassword => TranslationOverrides.string(_root.$meta, 'auth.newPassword', {}) ?? '新密码';

  /// zh-CN: '请输入新密码'
  String get enterNewPassword => TranslationOverrides.string(_root.$meta, 'auth.enterNewPassword', {}) ?? '请输入新密码';

  /// zh-CN: '重置密码'
  String get resetPasswordButton => TranslationOverrides.string(_root.$meta, 'auth.resetPasswordButton', {}) ?? '重置密码';

  /// zh-CN: '密码重置成功'
  String get resetPasswordSuccess =>
      TranslationOverrides.string(_root.$meta, 'auth.resetPasswordSuccess', {}) ?? '密码重置成功';

  /// zh-CN: '密码重置失败'
  String get resetPasswordFailed =>
      TranslationOverrides.string(_root.$meta, 'auth.resetPasswordFailed', {}) ?? '密码重置失败';

  /// zh-CN: '确认密码'
  String get confirmPassword => TranslationOverrides.string(_root.$meta, 'auth.confirmPassword', {}) ?? '确认密码';

  /// zh-CN: '请再次输入密码'
  String get enterConfirmPassword =>
      TranslationOverrides.string(_root.$meta, 'auth.enterConfirmPassword', {}) ?? '请再次输入密码';

  /// zh-CN: '两次输入的密码不一致'
  String get passwordNotMatch => TranslationOverrides.string(_root.$meta, 'auth.passwordNotMatch', {}) ?? '两次输入的密码不一致';
}
...
class TranslationsCouponZhCn {
  ...
  String conditionThreshold({required Object amount}) =>
      TranslationOverrides.string(_root.$meta, 'coupon.conditionThreshold', {'amount': amount}) ?? '满${amount}元可用';
  ...
  /// zh-CN: '无门槛'
  String get noThreshold => TranslationOverrides.string(_root.$meta, 'coupon.noThreshold', {}) ?? '无门槛';
...
class TranslationsHomeZhCn {
  ...
  /// zh-CN: '更多设备'
  String get moreDevices => TranslationOverrides.string(_root.$meta, 'home.moreDevices', {}) ?? '更多设备';
...
class TranslationsOrderZhCn {
  ...
  /// zh-CN: '余额支付'
  String get paymentBalance => TranslationOverrides.string(_root.$meta, 'order.paymentBalance', {}) ?? '余额支付';

  /// zh-CN: '现金支付'
  String get paymentCash => TranslationOverrides.string(_root.$meta, 'order.paymentCash', {}) ?? '现金支付';

  late final TranslationsOrderStatusDescZhCn statusDesc = TranslationsOrderStatusDescZhCn.internal(_root);
}
...
class TranslationsPointsZhCn {
  ...
  /// zh-CN: '我的积分'
  String get title => TranslationOverrides.string(_root.$meta, 'points.title', {}) ?? '我的积分';

  /// zh-CN: '积分'
  String get unit => TranslationOverrides.string(_root.$meta, 'points.unit', {}) ?? '积分';

  /// zh-CN: '积分商城'
  String get mall => TranslationOverrides.string(_root.$meta, 'points.mall', {}) ?? '积分商城';

  /// zh-CN: '去兑换'
  String get goExchange => TranslationOverrides.string(_root.$meta, 'points.goExchange', {}) ?? '去兑换';

  /// zh-CN: '积分规则'
  String get rules => TranslationOverrides.string(_root.$meta, 'points.rules', {}) ?? '积分规则';

  /// zh-CN: '积分永久有效'
  String get rule1 => TranslationOverrides.string(_root.$meta, 'points.rule1', {}) ?? '积分永久有效';

  /// zh-CN: '抽奖可获得额外积分'
  String get rule2 => TranslationOverrides.string(_root.$meta, 'points.rule2', {}) ?? '抽奖可获得额外积分';

  /// zh-CN: '积分记录'
  String get records => TranslationOverrides.string(_root.$meta, 'points.records', {}) ?? '积分记录';
  ...
  /// zh-CN: '暂无积分记录'
  String get noRecords => TranslationOverrides.string(_root.$meta, 'points.noRecords', {}) ?? '暂无积分记录';
  ...
  String myPoints({required Object points}) =>
      TranslationOverrides.string(_root.$meta, 'points.myPoints', {'points': points}) ?? '我的积分: ${points}';
  ...
  String cost({required Object points}) =>
      TranslationOverrides.string(_root.$meta, 'points.cost', {'points': points}) ?? '${points} 积分';
...
class TranslationsProductZhCn {
  ...
  /// zh-CN: '暂无商品'
  String get noProducts => TranslationOverrides.string(_root.$meta, 'product.noProducts', {}) ?? '暂无商品';
  ...
  /// zh-CN: '暂无详细介绍'
  String get noDescription => TranslationOverrides.string(_root.$meta, 'product.noDescription', {}) ?? '暂无详细介绍';

  /// zh-CN: '商品评价'
  String get reviews => TranslationOverrides.string(_root.$meta, 'product.reviews', {}) ?? '商品评价';

  /// zh-CN: '暂无评价'
  String get noReviews => TranslationOverrides.string(_root.$meta, 'product.noReviews', {}) ?? '暂无评价';
...
class TranslationsProfileZhCn {
  ...
  /// zh-CN: '积分'
  String get coin => TranslationOverrides.string(_root.$meta, 'profile.coin', {}) ?? '积分';
...
class TranslationsWelcomeGiftZhCn {
  ...
  /// zh-CN: '新人礼包'
  String get title => TranslationOverrides.string(_root.$meta, 'welcome_gift.title', {}) ?? '新人礼包';

  /// zh-CN: '注册30天内可领取，每个礼包限领一次'
  String get subtitle => TranslationOverrides.string(_root.$meta, 'welcome_gift.subtitle', {}) ?? '注册30天内可领取，每个礼包限领一次';

  late final TranslationsWelcomeGiftTabsZhCn tabs = TranslationsWelcomeGiftTabsZhCn.internal(_root);
  late final TranslationsWelcomeGiftCardZhCn card = TranslationsWelcomeGiftCardZhCn.internal(_root);
}
...
class TranslationsOrderStatusDescZhCn {
  ...
  /// zh-CN: '请尽快支付，过时订单将取消'
  String get pending => TranslationOverrides.string(_root.$meta, 'order.statusDesc.pending', {}) ?? '请尽快支付，过时订单将取消';

  /// zh-CN: '订单已支付，请凭码取货'
  String get paid => TranslationOverrides.string(_root.$meta, 'order.statusDesc.paid', {}) ?? '订单已支付，请凭码取货';

  /// zh-CN: '订单已完成，祝您生活愉快'
  String get completed => TranslationOverrides.string(_root.$meta, 'order.statusDesc.completed', {}) ?? '订单已完成，祝您生活愉快';

  /// zh-CN: '订单已展示，请及时取货'
  String get used => TranslationOverrides.string(_root.$meta, 'order.statusDesc.used', {}) ?? '订单已展示，请及时取货';

  /// zh-CN: '订单已取消，款项原路返回'
  String get cancelled => TranslationOverrides.string(_root.$meta, 'order.statusDesc.cancelled', {}) ?? '订单已取消，款项原路返回';

  /// zh-CN: '正在为您处理退款'
  String get refund => TranslationOverrides.string(_root.$meta, 'order.statusDesc.refund', {}) ?? '正在为您处理退款';

  /// zh-CN: '支付失败，请尝试重新下单'
  String get failed => TranslationOverrides.string(_root.$meta, 'order.statusDesc.failed', {}) ?? '支付失败，请尝试重新下单';
}
...
class TranslationsProfileWalletPageZhCn {
  ...
  String get ruleDesc =>
      TranslationOverrides.string(_root.$meta, 'profile.walletPage.ruleDesc', {}) ?? '充值部分套餐可获取积分，自选金额充值不获取积分';
  ...
  String bonus({required Object amount}) =>
      TranslationOverrides.string(_root.$meta, 'profile.walletPage.bonus', {'amount': amount}) ?? '送${amount}积分';

  /// zh-CN: '无积分'
  String get noBonus => TranslationOverrides.string(_root.$meta, 'profile.walletPage.noBonus', {}) ?? '无积分';
...
class TranslationsWelcomeGiftTabsZhCn {
  ...
  /// zh-CN: '可领取'
  String get available => TranslationOverrides.string(_root.$meta, 'welcome_gift.tabs.available', {}) ?? '可领取';

  /// zh-CN: '已领取'
  String get received => TranslationOverrides.string(_root.$meta, 'welcome_gift.tabs.received', {}) ?? '已领取';
}
...
class TranslationsWelcomeGiftCardZhCn {
  ...
  /// zh-CN: '礼包'
  String get tag => TranslationOverrides.string(_root.$meta, 'welcome_gift.card.tag', {}) ?? '礼包';
...
class TranslationsWelcomeGiftCardStatusZhCn {
  ...
  /// zh-CN: '已领取'
  String get received => TranslationOverrides.string(_root.$meta, 'welcome_gift.card.status.received', {}) ?? '已领取';
}
...
class TranslationsWelcomeGiftCardButtonZhCn {
  ...
  /// zh-CN: '领取'
  String get claim => TranslationOverrides.string(_root.$meta, 'welcome_gift.card.button.claim', {}) ?? '领取';

  /// zh-CN: '已领取'
  String get received => TranslationOverrides.string(_root.$meta, 'welcome_gift.card.button.received', {}) ?? '已领取';
}
...
class TranslationsProfileWalletPageRulesRechargeRulesZhCn {
  ...
  List<String> get items =>
      ...
      ['单次充值最低100元', '充值金额单次有100000元上限', '充值成功后立即到账', '充值金额可用于购买商品和支付订单', '充值部分套餐可获取积分，自选金额充值只可获取400积分'];
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    return switch (path) {
          ...
          'auth.resendCode' => TranslationOverrides.string(_root.$meta, 'auth.resendCode', {}) ?? '重新发送',
          'auth.email' => TranslationOverrides.string(_root.$meta, 'auth.email', {}) ?? '邮箱',
          'auth.enterEmail' => TranslationOverrides.string(_root.$meta, 'auth.enterEmail', {}) ?? '请输入邮箱',
          'auth.emailInvalid' => TranslationOverrides.string(_root.$meta, 'auth.emailInvalid', {}) ?? '邮箱格式不正确',
          'auth.oldPassword' => TranslationOverrides.string(_root.$meta, 'auth.oldPassword', {}) ?? '旧密码',
          'auth.enterOldPassword' => TranslationOverrides.string(_root.$meta, 'auth.enterOldPassword', {}) ?? '请输入旧密码',
          'auth.newPassword' => TranslationOverrides.string(_root.$meta, 'auth.newPassword', {}) ?? '新密码',
          'auth.enterNewPassword' => TranslationOverrides.string(_root.$meta, 'auth.enterNewPassword', {}) ?? '请输入新密码',
          'auth.resetPasswordButton' =>
            TranslationOverrides.string(_root.$meta, 'auth.resetPasswordButton', {}) ?? '重置密码',
          'auth.resetPasswordSuccess' =>
            TranslationOverrides.string(_root.$meta, 'auth.resetPasswordSuccess', {}) ?? '密码重置成功',
          'auth.resetPasswordFailed' =>
            TranslationOverrides.string(_root.$meta, 'auth.resetPasswordFailed', {}) ?? '密码重置失败',
          'auth.confirmPassword' => TranslationOverrides.string(_root.$meta, 'auth.confirmPassword', {}) ?? '确认密码',
          'auth.enterConfirmPassword' =>
            TranslationOverrides.string(_root.$meta, 'auth.enterConfirmPassword', {}) ?? '请再次输入密码',
          'auth.passwordNotMatch' =>
            TranslationOverrides.string(_root.$meta, 'auth.passwordNotMatch', {}) ?? '两次输入的密码不一致',
          ...
          'coupon.conditionNoThreshold' =>
            TranslationOverrides.string(_root.$meta, 'coupon.conditionNoThreshold', {}) ?? '满减券\n满0元可用',
          'coupon.noThreshold' => TranslationOverrides.string(_root.$meta, 'coupon.noThreshold', {}) ?? '无门槛',
          ...
          'order.paymentCash' => TranslationOverrides.string(_root.$meta, 'order.paymentCash', {}) ?? '现金支付',
          'order.statusDesc.pending' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.pending', {}) ?? '请尽快支付，过时订单将取消',
          'order.statusDesc.paid' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.paid', {}) ?? '订单已支付，请凭码取货',
          'order.statusDesc.completed' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.completed', {}) ?? '订单已完成，祝您生活愉快',
          'order.statusDesc.used' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.used', {}) ?? '订单已展示，请及时取货',
          'order.statusDesc.cancelled' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.cancelled', {}) ?? '订单已取消，款项原路返回',
          'order.statusDesc.refund' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.refund', {}) ?? '正在为您处理退款',
          'order.statusDesc.failed' =>
            TranslationOverrides.string(_root.$meta, 'order.statusDesc.failed', {}) ?? '支付失败，请尝试重新下单',
        ...
        switch (path) {
          ...
          'points.rules' => TranslationOverrides.string(_root.$meta, 'points.rules', {}) ?? '积分规则',
          ...
          'product.noProducts' => TranslationOverrides.string(_root.$meta, 'product.noProducts', {}) ?? '暂无商品',
          'product.loadingDetail' =>
            TranslationOverrides.string(_root.$meta, 'product.loadingDetail', {}) ?? '正在加载商品详情，请稍候...',
          'product.noDescription' => TranslationOverrides.string(_root.$meta, 'product.noDescription', {}) ?? '暂无详细介绍',
          'product.reviews' => TranslationOverrides.string(_root.$meta, 'product.reviews', {}) ?? '商品评价',
          'product.noReviews' => TranslationOverrides.string(_root.$meta, 'product.noReviews', {}) ?? '暂无评价',
          ...
          'profile.walletPage.noBonus' =>
            TranslationOverrides.string(_root.$meta, 'profile.walletPage.noBonus', {}) ?? '无积分',
          ...
          'time.daysAgo' =>
            ({required Object days}) =>
                TranslationOverrides.string(_root.$meta, 'time.daysAgo', {'days': days}) ?? '${days} 天前',
          'welcome_gift.title' => TranslationOverrides.string(_root.$meta, 'welcome_gift.title', {}) ?? '新人礼包',
          'welcome_gift.subtitle' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.subtitle', {}) ?? '注册30天内可领取，每个礼包限领一次',
          'welcome_gift.tabs.available' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.tabs.available', {}) ?? '可领取',
          'welcome_gift.tabs.received' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.tabs.received', {}) ?? '已领取',
          'welcome_gift.card.tag' => TranslationOverrides.string(_root.$meta, 'welcome_gift.card.tag', {}) ?? '礼包',
          'welcome_gift.card.status.received' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.card.status.received', {}) ?? '已领取',
          'welcome_gift.card.button.claim' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.card.button.claim', {}) ?? '领取',
          'welcome_gift.card.button.received' =>
            TranslationOverrides.string(_root.$meta, 'welcome_gift.card.button.received', {}) ?? '已领取',
          _ => null,
        };
  }
}
