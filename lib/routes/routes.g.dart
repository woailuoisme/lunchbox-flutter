...
RouteBase get $citySelectionRoute => GoRouteData.$route(
  path: '/city-selection',
  factory: $CitySelectionRoute._fromState,
);

mixin $CitySelectionRoute on GoRouteData {
  static CitySelectionRoute _fromState(GoRouterState state) =>
      const CitySelectionRoute();

  @override
  String get location => GoRouteData.$location('/city-selection');
...
RouteBase get $teamOrderingRoute => GoRouteData.$route(
  path: '/team-ordering',
  factory: $TeamOrderingRoute._fromState,
);

mixin $TeamOrderingRoute on GoRouteData {
  static TeamOrderingRoute _fromState(GoRouterState state) =>
      const TeamOrderingRoute();

  @override
  String get location => GoRouteData.$location('/team-ordering');
...
RouteBase get $communityRoute =>
    GoRouteData.$route(path: '/community', factory: $CommunityRoute._fromState);
...
RouteBase get $inviteRoute => GoRouteData.$route(
  ...
  routes: [
    GoRouteData.$route(path: 'rules', factory: $InviteRulesRoute._fromState),
  ],
);
...
mixin $InviteRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location('/invite');
...
mixin $InviteRulesRoute on GoRouteData {
  static InviteRulesRoute _fromState(GoRouterState state) =>
      const InviteRulesRoute();

  @override
  String get location => GoRouteData.$location('/invite/rules');
...
RouteBase get $lotteryRoute => GoRouteData.$route(
  path: '/lottery',
  factory: $LotteryRoute._fromState,
  routes: [
    GoRouteData.$route(path: 'prizes', factory: $MyPrizesRoute._fromState),
  ],
);

mixin $LotteryRoute on GoRouteData {
  static LotteryRoute _fromState(GoRouterState state) => const LotteryRoute();

  @override
  String get location => GoRouteData.$location('/lottery');
...
mixin $MyPrizesRoute on GoRouteData {
  static MyPrizesRoute _fromState(GoRouterState state) => const MyPrizesRoute();

  @override
  String get location => GoRouteData.$location('/lottery/prizes');
...
mixin $ProductListRoute on GoRouteData {
  static ProductListRoute _fromState(GoRouterState state) =>
      ProductListRoute(deviceId: state.pathParameters['deviceId']!);

  ProductListRoute get _self => this as ProductListRoute;

  @override
  String get location =>
      GoRouteData.$location('/products/${Uri.encodeComponent(_self.deviceId)}');
...
mixin $ProductDetailRoute on GoRouteData {
  static ProductDetailRoute _fromState(GoRouterState state) =>
      ProductDetailRoute(id: state.pathParameters['id']!);

  ProductDetailRoute get _self => this as ProductDetailRoute;

  @override
  String get location =>
      GoRouteData.$location('/product/${Uri.encodeComponent(_self.id)}');
...
mixin $OrderDetailRoute on GoRouteData {
  ...
  @override
  String get location =>
      GoRouteData.$location('/order/${Uri.encodeComponent(_self.id)}');
...
RouteBase get $myPointsRoute =>
    GoRouteData.$route(path: '/my-points', factory: $MyPointsRoute._fromState);

mixin $MyPointsRoute on GoRouteData {
  static MyPointsRoute _fromState(GoRouterState state) => const MyPointsRoute();

  @override
  String get location => GoRouteData.$location('/my-points');
...
RouteBase get $pointsMallRoute => GoRouteData.$route(
  path: '/points-mall',
  factory: $PointsMallRoute._fromState,
);

mixin $PointsMallRoute on GoRouteData {
  static PointsMallRoute _fromState(GoRouterState state) =>
      const PointsMallRoute();

  @override
  String get location => GoRouteData.$location('/points-mall');
...
RouteBase get $feedbackRoute =>
    GoRouteData.$route(path: '/feedback', factory: $FeedbackRoute._fromState);
...
RouteBase get $partnerRoute =>
    GoRouteData.$route(path: '/partner', factory: $PartnerRoute._fromState);

mixin $PartnerRoute on GoRouteData {
  static PartnerRoute _fromState(GoRouterState state) => const PartnerRoute();

  @override
  String get location => GoRouteData.$location('/partner');
...
mixin $DeviceInfoRoute on GoRouteData {
  static DeviceInfoRoute _fromState(GoRouterState state) =>
  ...
  branches: [
    ...
    StatefulShellBranchData.$branch(
      routes: [
        GoRouteData.$route(
          path: '/orders',
          factory: $OrderListRoute._fromState,
        ),
      ],
    ),
    StatefulShellBranchData.$branch(
...
mixin $OrderListRoute on GoRouteData {
